...
class Config:
    ...
    BOT_TOKEN = environ.get("BOT_TOKEN", "7900361662:AAHGhmp0lyxuJtC6ODvQ3c71wDFddLI8fyM") 
    ...
    BOT_OWNER = list(map(int, environ.get("BOT_OWNER", "5102717153,6283322330").split(",")))
